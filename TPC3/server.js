...
http.createServer((req, res) => {
    ...
    if(q.pathname == "/"){
        ...
        res.write("<ul>");
        res.write("<li><a href='http://localhost:2003/filmes'>Filmes</a></li>");
        res.write("<li><a href='http://localhost:2003/atores'>Atores</a></li>");
        res.write("<li><a href='http://localhost:2003/generos'>Géneros</a></li>");
        res.write("</ul>");
        ...
        axios.get("http://localhost:3000/filmes")
            .then(resp => {
                ...
                for(elem in lista){
                    var link = "http://localhost:2003/filmes/" + lista[elem]._id.$oid
        ...
        axios.get("http://localhost:3000/filmes")
            .then(resp => {
                ...
                atoresSet.forEach(ator => {
                    var link = "http://localhost:2003/atores/" + ator
        ...
        axios.get("http://localhost:3000/filmes")
            .then(resp => {
                ...
                generosSet.forEach(genero => {
                    var link = "http://localhost:2003/generos/" + genero
...
console.log("http://localhost:2003")
console.log("http://localhost:2003/filmes")
console.log("http://localhost:2003/atores")
console.log("http://localhost:2003/generos")
